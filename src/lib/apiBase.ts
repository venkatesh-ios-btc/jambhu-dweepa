 ...
 * - Prod on Vercel: same `/api` is handled by `api/[...path].js` (Node) → set BACKEND_URL in Vercel
 *   to your Node API origin (HTTPS, no trailing slash), then redeploy. Test /api/health after deploy.
